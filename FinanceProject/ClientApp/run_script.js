...
switch (action) {
    ...
    case "push":
        ...
        console.info(["azcopy", "copy", "./dist/*", `"https://financeappstore.file.core.windows.net/financeapp/wwwroot/finance?${process.env.storage_key}"`, "--recursive"].join(" "))
        proc = spawn("azcopy", ["copy", "./dist/*", `https://financeappstore.file.core.windows.net/financeapp/wwwroot/finance?${process.env.storage_key}`, "--recursive"])
        waitForExit()
