...
namespace FinanceProject.Migrations
{
    ...
    [Migration("20240831072308_AddUserInfoAndConfigs")]
    partial class AddUserInfoAndConfigs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FinanceProject.Models.ScheduledTransactions", b =>
                {
                    ...
                    b.Property<int>("LastTransactionIndex")
                        .HasColumnType("int");

                    b.Property<DateTime>("NextTransactionDate")
                        .HasColumnType("datetime2");

                    b.Property<int>("TotalOccurence")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("NextTransactionDate")
                        .IsDescending();
